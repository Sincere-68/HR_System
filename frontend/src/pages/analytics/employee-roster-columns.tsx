...
export const employeeRosterColumns: ColumnsType<EmployeeRosterListItem> = [
  ...
  { title: '籍贯', dataIndex: 'nativePlaceRegionName', width: 130, render: displayRosterValue },
  { title: '户籍所在地', dataIndex: 'householdRegionName', width: 220, render: displayRosterValue },

...
const employeeColumns: ColumnsType<EmployeeListItem> = [
  ...
  { title: '籍贯', dataIndex: 'nativePlaceRegionName', width: 200, render: displayValue },
  ...
  { title: '户籍所在地', dataIndex: 'householdRegionName', width: 240, render: displayValue },
  { title: '联系地址', dataIndex: 'residentialRegionName', width: 240, render: displayValue },

...
import { useWorkHistoryList } from '../../features/employee-subsets/api';
import { SubsetsListPage } from './SubsetsListPage';
import { workHistoryColumns } from './subset-table-configs';
...
export function WorkHistoryPage() {
  ...
  const workHistory = useWorkHistoryList(query);

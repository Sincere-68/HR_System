...
import { useLanguageList } from '../../features/employee-subsets/api';
import { SubsetsListPage } from './SubsetsListPage';
import { languageColumns } from './subset-table-configs';
...
export function LanguagesPage() {
  ...
  const languages = useLanguageList(query);

...
import { useFamilyList } from '../../features/employee-subsets/api';
import { SubsetsListPage } from './SubsetsListPage';
import { familyColumns } from './subset-table-configs';
...
export function FamilyPage() {
  ...
  const family = useFamilyList(query);

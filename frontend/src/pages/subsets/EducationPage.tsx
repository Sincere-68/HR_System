...
import { useEducationList } from '../../features/employee-subsets/api';
import { SubsetsListPage } from './SubsetsListPage';
import { educationColumns } from './subset-table-configs';
...
export function EducationPage() {
  ...
  const education = useEducationList(query);
